...
const checkAlive = (req: Request, res: Response) => {
...
export {userPost, userPut, userDelete, checkAlive, userListGet, userGet, checkToken, userDeleteAsAdmin, userPutAsAdmin, };
